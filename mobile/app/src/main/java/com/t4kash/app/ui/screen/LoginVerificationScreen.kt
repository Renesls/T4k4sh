...
fun LoginVerificationScreen(
    ...
    fun submit() {
        validationError = if (code.length != 6) {
        ...
        if (validationError == null) {
            ...
            viewModel.verifyLogin(initialEmail, code, onVerified)
        }
    }
    ...
    Scaffold(
        ...
        topBar = {
            T4TopBar(
                ...
                subtitle = "Segundo factor de seguridad",
                onBack = onBack
            )
        }
    ) { innerPadding ->
            ...
            item {
                T4PatternSurface(
                    ...
                    Column(
                        ...
                        Text(
                            text = "Enviamos un codigo a $initialEmail. La sesion se abrira solo despues de confirmarlo.",
            ...
            item {
                Card(
                    ...
                    Column(
                        ...
                        OutlinedButton(
                            onClick = {
                                viewModel.resendLoginVerification(initialEmail)
                            },
                            enabled = !uiState.isLoading,
                            modifier = Modifier.fillMaxWidth()
                        ) {
